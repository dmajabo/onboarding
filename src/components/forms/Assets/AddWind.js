...
const INSERT = gql`
    mutation ($object : asset_wind_table_insert_input!) {
      insert_asset_wind_table_one(object: $object) {
        id
      }
    }
`;
...
const AddWind = ({ account, refetch, disabled}) => {
                            ...
                            <Dialog open={open} fullWidth maxWidth="sm" >
                                ...
                                <DialogTitle id="id">
                                    <Box display="flex" alignItems="center">
                                        <Box flexGrow={1} >Add new Wind Plant</Box>
                                        <Box>
                                ...
                                <FormikTextField name="name" label="Wind Park Name" />

                                <FormikNumberField min={0} max={9999} name="number" label="Number of turbines" />

                                <FormikNumberField  min={0} max={99999} name="capacity" label="Capacity per turbine (kWh)" />
