...
const INSERT = gql`
    mutation ($object : asset_heatpump_table_insert_input!) {
      insert_asset_heatpump_table_one(object: $object) {
        id
      }
    }
`;
                        ...
                        <Dialog open={open} fullWidth maxWidth="sm" >
                            ...
                            <DialogTitle id="id">
                                <Box display="flex" alignItems="center">
                                    <Box flexGrow={1} >Add new Heat Pump</Box>
                                    <Box>
                                ...
                                <FormikTextField name="name" label="Heat Pump Name" />

                                <FormikNumberField  min={0} max={99999} name="capacity" label="Capacity (KW)" />
